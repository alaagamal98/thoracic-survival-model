...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\scshape\Large Cairo University\\ Faculty of Engineering\\System And Biomedical Engineering\\} % Editor affiliation
	...
	{\LARGE THORACIC   SURGERY\\ SURVIVAL\\} % Title
	...
	{\scshape\Large Asmaa Mahmoud Mahmoud\\ Alaa Gamal Abdelaziz\\Salma Mohamed Zakria\\Marwa Adel Youssef\\} % Editor list
...
\begin{table}[H]
\caption{Project Schedule} % title of Table
